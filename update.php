...
function wp_connect_header() {
	...
	if (isset($_POST['add_twitter'])) {
		header('Location:' . $plugin_url. '/login.php?go=twitter&act=bind');
	}
	if (isset($_POST['add_qq'])) {
		header('Location:' . $plugin_url. '/login.php?go=qq&act=bind');
	}
	if (isset($_POST['add_sina'])) {
		header('Location:' . $plugin_url. '/login.php?go=sina&act=bind');
	}
	if (isset($_POST['add_sohu'])) {
		header('Location:' . $plugin_url. '/login.php?go=sohu&act=bind');
	}
	if (isset($_POST['add_netease'])) {
		header('Location:' . $plugin_url. '/login.php?go=netease&act=bind');
	}
	if (isset($_POST['add_douban'])) {
		header('Location:' . $plugin_url. '/login.php?go=douban&act=bind');
	}
	if (isset($_POST['add_tianya'])) {
		header('Location:' . $plugin_url. '/login.php?go=tianya&act=bind');
	}
	if (isset($_POST['add_shuoshuo'])) {
		header('Location:' . $plugin_url . '-advanced/blogbind.php?bind=qzone');
	} 
	if (isset($_POST['add_renren'])) {
		header('Location:' . $plugin_url. '/login.php?go=renren&act=bind');
