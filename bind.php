...
$(".close").show();
$("<?php if($wptm_options['bind']) {echo '#twitter, #qq, #sina, #sohu, #netease, #douban, #tianya,';} elseif($wptm_options['enable_proxy']) {echo '#twitter,';}?><?php if(!is_donate()) echo '#renren,';?> #digu, #fanfou, #renjian, #zuosa, #wbto").click(function () {
