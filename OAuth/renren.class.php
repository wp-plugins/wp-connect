...
$config->CALLBACK = get_bloginfo('wpurl') . '/wp-content/plugins/wp-connect/renren.php'; //回调地址，注意和您申请的应用一致

$config->APIURL		= 'http://api.renren.com/restserver.do'; //RenRen网的API调用地址，不需要修改
$config->APIKey		= $wptm_connect['renren_api_key'];	//你的API Key，请自行申请
$config->SecretKey	= $wptm_connect['renren_secret'];	//你的API 密钥
