...
1. 可以使用腾讯微博、新浪微博、搜狐微博、网易微博、人人帐号、豆瓣帐号、Twitter登录WordPress博客，支持同步评论到相对应的微博。(捐赠版还支持用QQ、开心网、Google、Yahoo等登录WordPress博客)
...
5. 把文章出现的第一个视频同步到支持视频的微博。

6. 支持把文章分类和文章标签当成微博话题。

7. 支持自定义消息前缀。

8. 支持t.cn短网址。

9. 支持widget(小工具)拖拽激活 边栏登录按钮(在连接设置中开启)。

10. Twitter、腾讯微博、新浪微博、搜狐微博、网易微博、豆瓣采用OAuth授权。

11. 同步到Twitter时，国内主机用户可以选择使用代理，中国大陆地区第一次绑定帐号，必须翻墙一次。
