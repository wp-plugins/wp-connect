...
define('WP_CONNECT_VERSION', '1.9.21');
    ...
    <div id="advanced">
      <form method="post" action="options-general.php?page=wp-connect#advanced">
		...
		<?php if (!function_exists('wp_connect_advanced')) {?>
		 ...
		 <p><strong>最低捐赠：<a href="https://me.alipay.com/smyx" target="_blank">支付宝</a>(15元人民币起) 或者 <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=ZWMTWK2DGHCYS" target="_blank">PayPal</a>($5美元起) ，就当做是支持我继续开发插件的费用吧！<a href="http://www.smyx.net/wiki/wordpress/donate" target="_blank">查看详细描述</a></strong></p></p>
