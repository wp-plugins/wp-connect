...
Description: 支持使用15个第三方网站帐号登录 WordPress 博客，并且支持同步文章的 标题和链接 到14大微博和社区。<strong>注意：捐赠版已经更新到1.5.1 版本，请到群内下载升级！</strong>
Version: 1.9.1
*/

define('WP_CONNECT_VERSION', '1.9.1');
...
$wp_connect_advanced_version = "1.5.1";
