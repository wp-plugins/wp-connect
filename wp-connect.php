...
Description: 支持使用15家合作网站帐号登录 WordPress 博客，并且支持同步文章的 标题和链接 到14大微博和社区。<strong>注意：捐赠版已经更新到1.6.7 版本，请到群内下载升级！</strong>
Version: 1.9.22
*/

define('WP_CONNECT_VERSION', '1.9.22');
...
function wp_redirect_url() {
	...
	if ( is_home() ) {
		...
		return '&redirect_url=' . urlencode('http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']);
	} 
}
